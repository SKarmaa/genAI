					...
					<div className="max-w-8xl mx-auto
						...
						<div className="text-right flex justify-end items-center space-x-2 dark:invert w-full">
							<a className="duration-200
								...
								bg-black text-white"
								href="https://github.com/SKarmaa" target="_blank">
							SK
							</a>
							<a className="opacity-30 hover:opacity-100 duration-200" href="https://github.com/SKarmaa/genAI" target="_blank">
							...
							<a className="opacity-30 hover:opacity-100 duration-200" href="https://twitter.com/shrestha_08" target="_blank">
